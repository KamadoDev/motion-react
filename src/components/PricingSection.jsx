      ...
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='max-w-xl mx-auto'>
          ...
          <div className='text-center mt-12'>
            <p className="text-xl text-gray-600 mb-4">Read to get started</p>
            <button className='bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 cursor-pointer transition-colors'>Get Started</button>
          </div>
        </div>
      </div>
    </section>
