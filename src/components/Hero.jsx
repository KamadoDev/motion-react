        ...
        <section id='home' className='container mx-auto flex flex-col md:flex-row justify-between items-center pt-44 pb-6 px-4  sm:px-6 lg:px-8'>
            ...
            <div className='w-full md:w-1/2 space-y-8'>
                ...
                <motion.h1
                    ...
                    initial='hidden'
                    whileInView='show'
                    className='text-3xl md:text-4xl lg:text-5xl font-bold leading-tight'>We boost the growth for
                ...
                <motion.div
                    ...
                    <input type="text" placeholder='Email or your phone' className='flex-1 px-6 py-4 border border-gray-600 rounded-xl focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-100 transition-all' />
                    <button className='bg-blue-600 text-white px-8 py-4 rounded-xl hover:bg-blue-700 transition-all cursor-pointer hover:shadow-lg hover:shadow-blue-300'><FaLongArrowAltRight /></button>
                </motion.div>
            </div>
